...
module.exports = function(homebridge) {
	...
	FritzPlatform.PowerUsage.UUID = 'E863F10D-079E-48FF-8F27-9C2605A29F52';
    inherits(FritzPlatform.EnergyConsumption, Characteristic);
	FritzPlatform.EnergyConsumption.UUID = 'E863F10C-079E-48FF-8F27-9C2605A29F52';
    inherits(FritzPlatform.Temperature, Characteristic);
	FritzPlatform.Temperature.UUID = '00000011-0000-1000-8000-0026BB765291';
    inherits(FritzPlatform.ResetTotal, Characteristic);
	FritzPlatform.ResetTotal.UUID = 'E863F112-079E-48FF-8F27-9C2605A29F52';	
...
FritzPlatform.PowerUsage = function () {
	Characteristic.call(this, 'Power Usage', 'E863F10D-079E-48FF-8F27-9C2605A29F52');
	this.setProps({
...
FritzPlatform.Temperature = function () {
...
FritzPlatform.ResetTotal = function () {
...
/*	
FritzPlatform.InUse = function () {
		Characteristic.call(this, 'Verbrauch zurücksetzen', '00000026-0000-1000-8000-0026BB765292');
		this.setProps({
			format: Characteristic.Formats.UINT32,
			perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY, Characteristic.Perms.WRITE]
		});
